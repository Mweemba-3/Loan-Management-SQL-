...
public class AdminDashboard extends JPanel {
    ...
    private JButton createMenuButton(String text) {
        ...
        button.addActionListener(e -> {
            System.out.println("Admin menu button clicked: " + text);
    ...
    private void handleMenuClick(String menuItem) {
        ...
        System.out.println("Admin handling menu: " + menuText);
    ...
    private Map<String, Integer> fetchDashboardStats() {
        ...
        try {
            ...
            // SAME AS EMPLOYEE DASHBOARD - Use same queries for consistent totals
    ...
    private void updateDoughnutChart(Map<String, Integer> stats) {
        // SAME AS EMPLOYEE DASHBOARD - Use same data structure
    ...
    // SAME DOUGHNUT CHART AS EMPLOYEE DASHBOARD
