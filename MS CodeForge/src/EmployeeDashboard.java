...
public class EmployeeDashboard extends JPanel {
    ...
    private JButton createMenuButton(String text) {
        ...
        // FIX: Remove horizontal alignment that was blocking clicks
        ...
        // FIX: Add direct action listener with debug
        button.addActionListener(e -> {
            System.out.println("Menu button clicked: " + text);
    ...
    private void handleMenuClick(String menuItem) {
        ...
        System.out.println("Handling menu: " + menuText);
