...
public class ChangePasswordScreen extends JPanel {
    ...
    public ChangePasswordScreen(int employeeId, String userRole, String employeeName) {
        ...
        initUI();
        logActivity("Password Change", "Accessed password change screen");
    }
    ...
    private void goBackToDashboard() {
        if ("admin".equals(userRole)) {
            ScreenManager.getInstance().showScreen(new AdminDashboard(employeeId, employeeName));
        } else {
            ScreenManager.getInstance().showScreen(new EmployeeDashboard(employeeId, employeeName));
        }
    }
    ...
    private boolean verifyCurrentPassword(String password) {
        try (Connection conn = DatabaseConnection.getConnection()) {
            String sql = "SELECT password FROM employees WHERE employee_id = ? AND is_active = TRUE";
